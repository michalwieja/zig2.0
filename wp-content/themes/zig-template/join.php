    ...
    <form autocomplete="off" id="join-form">
      ...
      <div class="step">
        ...
        <div class="text-input__wrapper" id="username-input">
          ...
          <input type="email" class="text-input__input" autocomplete="new-password" name="username" id="input-username-input">
        ...
        <div class="text-input__wrapper" id="user_password-input">
          ...
          <input type="password" class="text-input__input" autocomplete="new-password" name="user_password" id="input-user_password-input">
