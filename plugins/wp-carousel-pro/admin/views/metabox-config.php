			...
			array(
				...
				'options' => array(
					...
					'product-carousel' => array(
						...
						'text' => __( 'Woo Product', 'wp-carousel-pro' ),
					),
...
SP_WPCP::createSection(
	...
	array(
		...
		'fields' => array(
			...
			array(
				'id'              => 'section_title_margin_',
				'class'           => 'wpcp-section-title-margin',
				'type'            => 'spacing',
				'title'           => __( 'Carousel Title Margin', 'wp-carousel-pro' ),
				'subtitle'        => __( 'Set margin for the carousel section title. Default value is 30px for bottom margin.', 'wp-carousel-pro' ),
				'units'           => array(
					'px',
				),
			...
			array(
				...
				'options'    => array(
					'link'  => __( 'Link', 'wp-carousel-pro' ),
					'l_box' => __( 'Lightbox', 'wp-carousel-pro' ),
					'none'  => __( 'None', 'wp-carousel-pro' ),
				),
				'subtitle'   => __( 'Select a linking type for the images.', 'wp-carousel-pro' ),
				'default'    => 'l_box',
			...
			array(
				...
				'subtitle'   => __( 'Set overlay color for lightbox.', 'wp-carousel-pro' ),
				'default'    => '#0b0b0b',
				'dependency' => array( 'wpcp_carousel_type|wpcp_logo_link_show', '==|==|==', 'image-carousel|l_box' ),
			),
			array(
				'id'         => 'wpcp_image_counter',
				'type'       => 'switcher',
				'title'      => __( 'Lightbox Image Counter', 'wp-carousel-pro' ),
			...
			array(
				...
				'type'       => 'switcher',
				'title'      => __( 'Lightbox Image Caption', 'wp-carousel-pro' ),
			...
			array(
				...
				'type'       => 'color',
				'title'      => __( 'Lightbox Caption Color', 'wp-carousel-pro' ),
				'subtitle'   => __( 'Change the color for image caption.', 'wp-carousel-pro' ),
				'default'    => '#ffffff',
				'dependency' => array( 'wpcp_carousel_type|wpcp_logo_link_show|wpcp_l_box_image_caption', '==|==|==', 'image-carousel|l_box|true' ),

			),
			array(
				'id'         => 'wpcp_thumbnails_gallery',
				'type'       => 'switcher',
				'title'      => __( 'Lightbox Bottom Thumbnails Gallery', 'wp-carousel-pro' ),
				'subtitle'   => __( 'Show/Hide bottom thumbnails gallery for lightbox.', 'wp-carousel-pro' ),
				'text_on'    => __( 'Show', 'wp-carousel-pro' ),
				'text_off'   => __( 'Hide', 'wp-carousel-pro' ),
				'text_width' => 77,
				'default'    => true,
			...
			array(
				'id'         => 'wpcp_lb_control',
				'type'       => 'switcher',
				'title'      => __( 'Lightbox Controls', 'wp-carousel-pro' ),
				'subtitle'   => __( 'Show/Hide controls for lightbox.', 'wp-carousel-pro' ),
				'text_on'    => __( 'Show', 'wp-carousel-pro' ),
				'text_off'   => __( 'Hide', 'wp-carousel-pro' ),
				'text_width' => 77,
				'default'    => true,
			...
			array(
				...
				'default'    => false,
				'dependency' => array( 'wpcp_carousel_type|wpcp_logo_link_show', '==|!=', 'image-carousel|none', true ),
			),
			array(
				'id'         => 'wpcp_link_open_target',
				'type'       => 'select',
				'title'      => __( 'Link Target', 'wp-carousel-pro' ),
	...
	array(
		...
		'fields' => array(
			...
			array(
				...
				'subtitle'        => __( 'Set sliding or scrolling speed. Default value is 600 milliseconds.', 'wp-carousel-pro' ),
				'all'             => true,
				'all_text'        => false,
				'all_placeholder' => 'speed',
				'default'         => array(
			...
			array(
				...
				'dependency' => array( 'wpcp_carousel_mode|wpcp_carousel_orientation', '==|!=', 'standard|vertical' ),
			),
			array(
			...
			array(
				...
				'subtitle'   => __( 'Set a sliding effect. Fade for single column view.', 'wp-carousel-pro' ),
				'options'    => array(
				...
				'dependency' => array( 'wpcp_carousel_mode|wpcp_carousel_orientation', '!=|==', 'ticker|horizontal' ),

			),
			// Navigation.
			array(
				'type'       => 'subheading',
				'content'    => __( 'Navigation', 'wp-carousel-pro' ),
				'dependency' => array( 'wpcp_carousel_mode', '!=', 'ticker' ),
			),
			array(
				'id'         => 'wpcp_navigation',
			...
			array(
				'id'         => 'navigation_icons',
				'type'       => 'button_set',
				'title'      => __( 'Choose an Icon', 'wp-carousel-pro' ),
			...
			array(
				'type'       => 'subheading',
				'content'    => __( 'Pagination', 'wp-carousel-pro' ),
				'dependency' => array( 'wpcp_carousel_mode', '!=', 'ticker' ),
			),
			array(
				'id'         => 'wpcp_pagination',
			...
			array(
				'type'       => 'subheading',
				'content'    => __( 'Miscellaneous', 'wp-carousel-pro' ),
				'dependency' => array( 'wpcp_carousel_mode', '!=', 'ticker' ),
			),
	...
	array(
		...
		'fields' => array(
			...
			array(
				...
				'min'        => 0,
				'unit'       => 'Letters',
				'dependency' => array( 'wpcp_carousel_type|wpcp_post_title', '==|==', 'post-carousel|true' ),
			),
			array(
			...
			array(
				'type'       => 'subheading',
				'content'    => __( 'Product', 'wp-carousel-pro' ),
				'dependency' => array( 'wpcp_carousel_type', '==', 'product-carousel' ),
			),
			array(
			...
			array(
				...
				'min'        => 0,
				'unit'       => 'Letters',
				'dependency' => array( 'wpcp_carousel_type|wpcp_product_name', '==|==', 'product-carousel|true' ),
			),
			array(
			...
			array(
				...
				'type'       => 'spinner',
				'title'      => __( 'Description Words Count', 'wp-carousel-pro' ),
				'subtitle'   => __( 'Number of words to show as the product description. Default value is 15 words.', 'wp-carousel-pro' ),
				'default'    => '15',
				'min'        => 0,
			...
			array(
				'type'       => 'subheading',
				'content'    => __( 'Image', 'wp-carousel-pro' ),
				'dependency' => array( 'wpcp_carousel_type', '!=', 'content-carousel' ),
			),
			array(
				'id'         => 'show_image',
			...
			array(
				...
				'subtitle'           => __( 'Set image height on different devices for perfect responsive in px.', 'wp-carousel-pro' ),
			...
			array(
				...
				'class'           => 'wpcp-image-border-radius',
				'type'            => 'dimensions_advanced',
				'title'           => __( 'Border Radius', 'wp-carousel-pro' ),
			...
			array(
				...
				'default'    => false,
				'dependency' => array( 'wpcp_carousel_mode|wpcp_carousel_type|wpcp_carousel_orientation', '!=|!=|!=', 'ticker|content-carousel|vertical' ),
			),
			array(
				'id'         => '_image_light_box',
				'type'       => 'switcher',
				...
				'default'    => false,
				'dependency' => array( 'wpcp_carousel_type|show_image', '==|==', 'product-carousel|true' ),
			),
			array(
				...
				'default'    => '#0b0b0b',
				'dependency' => array( 'wpcp_carousel_type|show_image|_image_light_box', '==|==|==', 'product-carousel|true|true' ),
			),
			array(
			...
			array(
				...
				'subtitle' => __( 'Set a mode for the image.', 'wp-carousel-pro' ),
				'options'  => array(
					''                         => __( 'Normal', 'wp-carousel-pro' ),
					'gray_and_normal_on_hover' => __( 'Grayscale and normal on hover', 'wp-carousel-pro' ),
