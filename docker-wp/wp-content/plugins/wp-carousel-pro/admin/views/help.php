			...
			<div class="feature-section three-col">
				...
				<div class="col">
					<div class="sp-wpcp-feature text-center">
						...
						<a href="https://docs.shapedplugin.com/docs/wordpress-carousel-pro/introduction/" target="_blank" class="button button-primary">' . esc_html__( 'Documentation', 'wp-carousel-pro' ) . '</a>
					</div>
				</div>
				<div class="col">
					<div class="sp-wpcp-feature text-center">
